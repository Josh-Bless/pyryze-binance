package com.pyryze.binance.connector.client.impl.websocketapi;
...
public class WebSocketApiTrade {
     ...
     * trailingDelta -- optional/int -- see https://github.com.pyryze.binance/binance-spot-api-docs/blob/master/faqs/trailing-stop-faq.md<br>
