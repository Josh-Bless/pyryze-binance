...
public class Trade {
    ...
    private final AsyncRequestHandler asynRequestHandler;
    private final boolean showLimitUsage;

    public Trade(String baseUrl, String apiKey, String secretKey, boolean showLimitUsage, ProxyAuth proxy) {
        this.baseUrl = baseUrl;
        this.asynRequestHandler = new AsyncRequestHandler(apiKey, new HmacSignatureGenerator(secretKey), proxy);
     ...
     */
    public Mono<String> testNewOrder(LinkedHashMap<String, Object> parameters) {
        ParameterChecker.checkParameter(parameters, "symbol", String.class);
        ParameterChecker.checkParameter(parameters, "side", String.class);
        ParameterChecker.checkParameter(parameters, "type", String.class);
        return asynRequestHandler.sendSignedRequest(baseUrl, TEST_NEW_ORDER, parameters, HttpMethod.POST, showLimitUsage);
    }
    ...
    public Mono<String> newOrder(LinkedHashMap<String, Object> parameters) {
        ...
        ParameterChecker.checkParameter(parameters, "side", String.class);
        ParameterChecker.checkParameter(parameters, "type", String.class);
        return asynRequestHandler.sendSignedRequest(baseUrl, ORDER, parameters, HttpMethod.POST, showLimitUsage);
    }
    ...
    public Mono<String> cancelOrder(LinkedHashMap<String, Object> parameters) {
        ParameterChecker.checkParameter(parameters, "symbol", String.class);
        return asynRequestHandler.sendSignedRequest(baseUrl, ORDER, parameters, HttpMethod.DELETE, showLimitUsage);
    }
    ...
    public Mono<String> cancelOpenOrders(LinkedHashMap<String, Object> parameters) {
        ParameterChecker.checkParameter(parameters, "symbol", String.class);
        return asynRequestHandler.sendSignedRequest(baseUrl, ALL_OPEN_ORDERS, parameters, HttpMethod.DELETE, showLimitUsage);
    }
    ...
    public Mono<String> getOrder(LinkedHashMap<String, Object> parameters) {
        ParameterChecker.checkParameter(parameters, "symbol", String.class);
        return asynRequestHandler.sendSignedRequest(baseUrl, ORDER, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> cancelReplace(LinkedHashMap<String, Object> parameters) {
        ParameterChecker.checkParameter(parameters, "symbol", String.class);
        ParameterChecker.checkParameter(parameters, "side", String.class);
        ParameterChecker.checkParameter(parameters, "type", String.class);
        ParameterChecker.checkParameter(parameters, "cancelReplaceMode", String.class);
        return asynRequestHandler.sendSignedRequest(baseUrl, CANCEL_REPLACE, parameters, HttpMethod.POST, showLimitUsage);
    }
    ...
    public Mono<String> getOpenOrders(LinkedHashMap<String, Object> parameters) {
        return asynRequestHandler.sendSignedRequest(baseUrl, ALL_OPEN_ORDERS, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> getOrders(LinkedHashMap<String, Object> parameters) {
        ParameterChecker.checkParameter(parameters, "symbol", String.class);
        return asynRequestHandler.sendSignedRequest(baseUrl, ALL_ORDERS, parameters, HttpMethod.GET, showLimitUsage);
    }
    ...
    public Mono<String> ocoOrder(LinkedHashMap<String, Object> parameters) {
        ...
        return asynRequestHandler.sendSignedRequest(baseUrl, OCO_ORDER, parameters, HttpMethod.POST, showLimitUsage);
    }
     ...
     */
    public Mono<String> cancelOCO(LinkedHashMap<String, Object> parameters) {
        ParameterChecker.checkParameter(parameters, "symbol", String.class);
        return asynRequestHandler.sendSignedRequest(baseUrl, OCO_LIST, parameters, HttpMethod.DELETE, showLimitUsage);
    }
    ...
    public Mono<String> getOCOOrder(LinkedHashMap<String, Object> parameters) {
        return asynRequestHandler.sendSignedRequest(baseUrl, OCO_LIST, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     *     https://binance-docs.github.io/apidocs/spot/en/#query-oco-user_data</a>
     */
    public Mono<String> getOCOOrders(LinkedHashMap<String, Object> parameters) {
        return asynRequestHandler.sendSignedRequest(baseUrl, ALL_OCO_LIST, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> getOpenOCOOrders(LinkedHashMap<String, Object> parameters) {
        return asynRequestHandler.sendSignedRequest(baseUrl, ALL_OPEN_OCO_LIST, parameters, HttpMethod.GET, showLimitUsage);
    }
    ...
    public Mono<String> account(LinkedHashMap<String, Object> parameters) {
        return asynRequestHandler.sendSignedRequest(baseUrl, ACCOUNT_INFO, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> myTrades(LinkedHashMap<String, Object> parameters) {
        ParameterChecker.checkParameter(parameters, "symbol", String.class);
        return asynRequestHandler.sendSignedRequest(baseUrl, ACCOUNT_TRADES, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> rateLimitOrder(LinkedHashMap<String, Object> parameters) {
        return asynRequestHandler.sendSignedRequest(baseUrl, RATE_LIMIT, parameters, HttpMethod.GET, showLimitUsage);
    }
}
