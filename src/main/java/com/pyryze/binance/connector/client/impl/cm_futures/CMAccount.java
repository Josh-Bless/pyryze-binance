package com.pyryze.binance.connector.client.impl.cm_futures;
...
public class CMAccount extends Account {
     ...
     */
    public Mono<String> modifyOrder(LinkedHashMap<String, Object> parameters) {
     ...
     */
    public Mono<String> orderModifyHistory(LinkedHashMap<String, Object> parameters) {
        ParameterChecker.checkParameter(parameters, "symbol", String.class);
     ...
     */
    public Mono<String> getLeverageBracketForPair(LinkedHashMap<String, Object> parameters) {
