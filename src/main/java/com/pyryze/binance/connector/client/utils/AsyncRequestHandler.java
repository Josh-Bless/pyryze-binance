...
public class AsyncRequestHandler {
    ...
    public AsyncRequestHandler(String apiKey, ProxyAuth proxy) {
        this(apiKey, null, proxy);
    }

    public AsyncRequestHandler(String apiKey, SignatureGenerator signatureGenerator, ProxyAuth proxy) {
        this.apiKey = apiKey;
    ...
    private Mono<String> sendApiAsyncRequest(
        String baseUrl, 
        ...
        return ResponseHandler.handleAsyncResponse(request, showLimitUsage, proxy, properties);
    }
    
    public Mono<String> sendPublicRequest(
        String baseUrl, 
        String urlPath, 
        LinkedHashMap<String, Object> parameters,
        HttpMethod httpMethod, 
        ...
        return sendApiAsyncRequest(baseUrl, urlPath, null, parameters, httpMethod, RequestType.PUBLIC, showLimitUsage);
    }

    public Mono<String> sendWithApiKeyRequest(
        String baseUrl, 
        String urlPath, 
        LinkedHashMap<String, Object> parameters,
        HttpMethod httpMethod, 
        ...
        return sendApiAsyncRequest(baseUrl, urlPath, null, parameters, httpMethod, RequestType.WITH_API_KEY, showLimitUsage);
    }

    public Mono<String> sendSignedRequest(
        String baseUrl, 
        String urlPath, 
        LinkedHashMap<String, Object> parameters,
        HttpMethod httpMethod, 
        ...
        return this.signatureGenerator.getSignatureAsynchronously(queryString)
        .flatMap(signature -> {
            return sendApiAsyncRequest(baseUrl, urlPath, signature, parameters, httpMethod, RequestType.SIGNED, showLimitUsage);
        });
    }
