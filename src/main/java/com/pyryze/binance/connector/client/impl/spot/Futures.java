...
public class Futures {
    ...
    public Mono<String> futuresTransfer(LinkedHashMap<String, Object> parameters) {
        ...
        return asynRequestHandler.sendSignedRequest(baseUrl, FUTURES_TRANSFER, parameters, HttpMethod.POST, showLimitUsage);
    }
     ...
     */
    public Mono<String> futuresTransferHistory(LinkedHashMap<String, Object> parameters) {
        ParameterChecker.checkParameter(parameters, "asset", String.class);
        ParameterChecker.checkParameter(parameters, "startTime", Long.class);
        return asynRequestHandler.sendSignedRequest(baseUrl, FUTURES_TRANSFER, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> borrowHistory(LinkedHashMap<String, Object> parameters) {
        return asynRequestHandler.sendSignedRequest(baseUrl, BORROW_HISTORY, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> repayHistory(LinkedHashMap<String, Object> parameters) {
        return asynRequestHandler.sendSignedRequest(baseUrl, REPAY_HISTORY, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> loanWallet(LinkedHashMap<String, Object> parameters) {
        return asynRequestHandler.sendSignedRequest(baseUrl, WALLET, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> adjustCollateralHistory(LinkedHashMap<String, Object> parameters) {
        return asynRequestHandler.sendSignedRequest(baseUrl, ADJUST_COLLATERAL_HISTORY, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> liquidationHistory(LinkedHashMap<String, Object> parameters) {
        return asynRequestHandler.sendSignedRequest(baseUrl, LIQUIDATION_HISTORY, parameters, HttpMethod.GET, showLimitUsage);
    }
    ...
    public Mono<String> interestHistory(LinkedHashMap<String, Object> parameters) {
        return asynRequestHandler.sendSignedRequest(baseUrl, INTEREST_HISTORY, parameters, HttpMethod.GET, showLimitUsage);
    }
}
