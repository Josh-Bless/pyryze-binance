...
public class Wallet {
    ...
    private final AsyncRequestHandler asyncRquestHandler;
    private final boolean showLimitUsage;

    public Wallet(String baseUrl, String apiKey, String secretKey, boolean showLimitUsage, ProxyAuth proxy) {
        this.baseUrl = baseUrl;
        this.asyncRquestHandler = new AsyncRequestHandler(apiKey, new HmacSignatureGenerator(secretKey), proxy);
    ...
    public Wallet(String baseUrl, String apiKey, SignatureGenerator signatureGenerator, boolean showLimitUsage, ProxyAuth proxy) {
        this.baseUrl = baseUrl;
        this.asyncRquestHandler = new AsyncRequestHandler(apiKey, signatureGenerator, proxy);
        this.showLimitUsage = showLimitUsage;
    }
     ...
     */
    public Mono<String> systemStatus() {
        return asyncRquestHandler.sendPublicRequest(baseUrl, SYSTEM_STATUS, null, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> coinInfo(LinkedHashMap<String, Object> parameters) {
        return asyncRquestHandler.sendSignedRequest(baseUrl, COIN_INFO, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> accountSnapshot(LinkedHashMap<String, Object> parameters) {
        ParameterChecker.checkParameter(parameters, "type", String.class);
        return asyncRquestHandler.sendSignedRequest(baseUrl, ACC_SNAP, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> disableFastWithdraw(LinkedHashMap<String, Object> parameters) {
        return asyncRquestHandler.sendSignedRequest(baseUrl, DISABLE_FAST, parameters, HttpMethod.POST, showLimitUsage);
    }
     ...
     */
    public Mono<String> enableFastWithdraw(LinkedHashMap<String, Object> parameters) {
        return asyncRquestHandler.sendSignedRequest(baseUrl, ENABLE_FAST, parameters, HttpMethod.POST, showLimitUsage);
    }
     ...
     */
    public Mono<String> withdraw(LinkedHashMap<String, Object> parameters) {
        ...
        return asyncRquestHandler.sendSignedRequest(baseUrl, WITHDRAW, parameters, HttpMethod.POST, showLimitUsage);
    }
    ...
    public Mono<String> depositHistory(LinkedHashMap<String, Object> parameters) {
        return asyncRquestHandler.sendSignedRequest(baseUrl, DEPOSIT_HIST, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> withdrawHistory(LinkedHashMap<String, Object> parameters) {
        return asyncRquestHandler.sendSignedRequest(baseUrl, WITHDRAW_HIST, parameters, HttpMethod.GET, showLimitUsage);
    }
    ...
    public Mono<String> depositAddress(LinkedHashMap<String, Object> parameters) {
        ParameterChecker.checkParameter(parameters, "coin", String.class);
        return asyncRquestHandler.sendSignedRequest(baseUrl, DEPOSIT_ADD, parameters, HttpMethod.GET, showLimitUsage);
    }
    ...
    public Mono<String> accountStatus(LinkedHashMap<String, Object> parameters) {
        return asyncRquestHandler.sendSignedRequest(baseUrl, ACC_STATUS, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> apiTradingStatus(LinkedHashMap<String, Object> parameters) {
        return asyncRquestHandler.sendSignedRequest(baseUrl, API_TRADE_STATUS, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> dustLog(LinkedHashMap<String, Object> parameters) {
        return asyncRquestHandler.sendSignedRequest(baseUrl, DUST_LOG, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> bnbConvertableAssets(LinkedHashMap<String, Object> parameters) {
        return asyncRquestHandler.sendSignedRequest(baseUrl, BNB_CONVERTABLE_ASSETS, parameters, HttpMethod.POST, showLimitUsage);
    }
     ...
     */
    public Mono<String> dustTransfer(LinkedHashMap<String, Object> parameters) {
        ParameterChecker.checkParameter(parameters, "asset", ArrayList.class);
        return asyncRquestHandler.sendSignedRequest(baseUrl, DUST_TRANSFER, parameters, HttpMethod.POST, showLimitUsage);
    }
     ...
     */
    public Mono<String> assetDividend(LinkedHashMap<String, Object> parameters) {
        return asyncRquestHandler.sendSignedRequest(baseUrl, ASSET_DIVIDEND, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> assetDetail(LinkedHashMap<String, Object> parameters) {
        return asyncRquestHandler.sendSignedRequest(baseUrl, ASSET_DETAIL, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> tradeFee(LinkedHashMap<String, Object> parameters) {
        return asyncRquestHandler.sendSignedRequest(baseUrl, TRADE_FEE, parameters, HttpMethod.GET, showLimitUsage);
    }
    ...
    public Mono<String> universalTransfer(LinkedHashMap<String, Object> parameters) {
        ...
        ParameterChecker.checkRequiredParameter(parameters, "amount");
        return asyncRquestHandler.sendSignedRequest(baseUrl, UNIVERSAL_TRANSFER, parameters, HttpMethod.POST, showLimitUsage);
    }
    ...
    public Mono<String> queryUniversalTransfer(LinkedHashMap<String, Object> parameters) {
        ParameterChecker.checkParameter(parameters, "type", String.class);
        return asyncRquestHandler.sendSignedRequest(baseUrl, UNIVERSAL_TRANSFER, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> fundingWallet(LinkedHashMap<String, Object> parameters) {
        return asyncRquestHandler.sendSignedRequest(baseUrl, FUNDING_WALLET, parameters, HttpMethod.POST, showLimitUsage);
    }
     ...
     */
    public Mono<String> apiPermission(LinkedHashMap<String, Object> parameters) {
        return asyncRquestHandler.sendSignedRequest(baseUrl, API_PERMISSION, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> getUserAsset(LinkedHashMap<String, Object> parameters) {
        return asyncRquestHandler.sendSignedRequest(baseUrl, USER_ASSET, parameters, HttpMethod.POST, showLimitUsage);
    }
     ...
     */
    public Mono<String> busdConvert(LinkedHashMap<String, Object> parameters) {
        ...
        return asyncRquestHandler.sendSignedRequest(baseUrl, BUSD_CONVERT, parameters, HttpMethod.POST, showLimitUsage);
    }
     ...
     */
    public Mono<String> busdConvertHistory(LinkedHashMap<String, Object> parameters) {
        ...
        return asyncRquestHandler.sendSignedRequest(baseUrl, BUSD_CONVERT_HISTORY, parameters, HttpMethod.GET, showLimitUsage);
    }
