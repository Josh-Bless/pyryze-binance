...
public class Margin {
     ...
     */
    public Mono<String> crossMarginTransfer(LinkedHashMap<String, Object> parameters) {
        ParameterChecker.checkParameter(parameters, "asset", String.class);
        ParameterChecker.checkRequiredParameter(parameters, "amount");
        ParameterChecker.checkParameter(parameters, "type", Integer.class);
        return asyncRequestHandler.sendSignedRequest(baseUrl, CROSS_MARGIN_TRANSFER, parameters, HttpMethod.POST, showLimitUsage);
    }
     ...
     */
    public Mono<String> borrow(LinkedHashMap<String, Object> parameters) {
        ParameterChecker.checkParameter(parameters, "asset", String.class);
        ParameterChecker.checkRequiredParameter(parameters, "amount");
        return asyncRequestHandler.sendSignedRequest(baseUrl, BORROW, parameters, HttpMethod.POST, showLimitUsage);
    }
     ...
     */
    public Mono<String> asset(LinkedHashMap<String, Object> parameters) {
        ParameterChecker.checkParameter(parameters, "asset", String.class);
        return asyncRequestHandler.sendWithApiKeyRequest(baseUrl, ASSET, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> pair(LinkedHashMap<String, Object> parameters) {
        ParameterChecker.checkParameter(parameters, "symbol", String.class);
        return asyncRequestHandler.sendWithApiKeyRequest(baseUrl, PAIR, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> allAssets() {
        return asyncRequestHandler.sendWithApiKeyRequest(baseUrl, ALL_ASSETS, null, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> allPairs() {
        return asyncRequestHandler.sendWithApiKeyRequest(baseUrl, ALL_PAIRS, null, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> priceIndex(LinkedHashMap<String, Object> parameters) {
        ParameterChecker.checkParameter(parameters, "symbol", String.class);
        return asyncRequestHandler.sendWithApiKeyRequest(baseUrl, PRICE_INDEX, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> newOrder(LinkedHashMap<String, Object> parameters) {
        ParameterChecker.checkParameter(parameters, "symbol", String.class);
        ParameterChecker.checkParameter(parameters, "side", String.class);
        ParameterChecker.checkParameter(parameters, "type", String.class);
        return asyncRequestHandler.sendSignedRequest(baseUrl, ORDER, parameters, HttpMethod.POST, showLimitUsage);
    }
     ...
     */
    public Mono<String> cancelOrder(LinkedHashMap<String, Object> parameters) {
        ParameterChecker.checkParameter(parameters, "symbol", String.class);
        return asyncRequestHandler.sendSignedRequest(baseUrl, ORDER, parameters, HttpMethod.DELETE, showLimitUsage);
    }
     ...
     */
    public Mono<String> cancelOpenOrders(LinkedHashMap<String, Object> parameters) {
        ParameterChecker.checkParameter(parameters, "symbol", String.class);
        return asyncRequestHandler.sendSignedRequest(baseUrl, OPEN_ORDERS, parameters, HttpMethod.DELETE, showLimitUsage);
    }
     ...
     */
    public Mono<String> transferHistory(LinkedHashMap<String, Object> parameters) {
        return asyncRequestHandler.sendSignedRequest(baseUrl, TRANSFER_HISTORY, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> loanRecord(LinkedHashMap<String, Object> parameters) {
        ParameterChecker.checkParameter(parameters, "asset", String.class);
        return asyncRequestHandler.sendSignedRequest(baseUrl, LOAN_RECORD, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> repayRecord(LinkedHashMap<String, Object> parameters) {
        ParameterChecker.checkParameter(parameters, "asset", String.class);
        return asyncRequestHandler.sendSignedRequest(baseUrl, REPAY_RECORD, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> interestHistory(LinkedHashMap<String, Object> parameters) {
        return asyncRequestHandler.sendSignedRequest(baseUrl, INTEREST_HISTORY, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> forceLiquidationRec(LinkedHashMap<String, Object> parameters) {
        return asyncRequestHandler.sendSignedRequest(baseUrl, FORCE_LIQUIDATION_RECORD, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> account(LinkedHashMap<String, Object> parameters) {
     ...
     */
    public Mono<String> getOrder(LinkedHashMap<String, Object> parameters) {
        ParameterChecker.checkParameter(parameters, "symbol", String.class);
        return asyncRequestHandler.sendSignedRequest(baseUrl, ORDER, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> getOpenOrders(LinkedHashMap<String, Object> parameters) {
        return asyncRequestHandler.sendSignedRequest(baseUrl, OPEN_ORDERS, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> getAllOrders(LinkedHashMap<String, Object> parameters) {
        ParameterChecker.checkParameter(parameters, "symbol", String.class);
        return asyncRequestHandler.sendSignedRequest(baseUrl, ALL_ORDERS, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> ocoOrder(LinkedHashMap<String, Object> parameters) {
        ParameterChecker.checkParameter(parameters, "symbol", String.class);
        ParameterChecker.checkParameter(parameters, "side", String.class);
        ...
        return asyncRequestHandler.sendSignedRequest(baseUrl, OCO_ORDER, parameters, HttpMethod.POST, showLimitUsage);
    }
     ...
     */
    public Mono<String> cancelOcoOrder(LinkedHashMap<String, Object> parameters) {
        ParameterChecker.checkParameter(parameters, "symbol", String.class);
        return asyncRequestHandler.sendSignedRequest(baseUrl, ORDER_LIST, parameters, HttpMethod.DELETE, showLimitUsage);
    }
     ...
     */
    public Mono<String> getOcoOrder(LinkedHashMap<String, Object> parameters) {
        return asyncRequestHandler.sendSignedRequest(baseUrl, ORDER_LIST, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> getAllOcoOrders(LinkedHashMap<String, Object> parameters) {
        return asyncRequestHandler.sendSignedRequest(baseUrl, GET_ALL_OCO, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> getOcoOpenOrders(LinkedHashMap<String, Object> parameters) {
        return asyncRequestHandler.sendSignedRequest(baseUrl, GET_OPEN_OCO, parameters, HttpMethod.GET, showLimitUsage);
    }
    ...
    public Mono<String> trades(LinkedHashMap<String, Object> parameters) {
        ParameterChecker.checkParameter(parameters, "symbol", String.class);
        return asyncRequestHandler.sendSignedRequest(baseUrl, MY_TRADES, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> maxBorrow(LinkedHashMap<String, Object> parameters) {
        ParameterChecker.checkParameter(parameters, "asset", String.class);
        return asyncRequestHandler.sendSignedRequest(baseUrl, MAX_BORROW, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> maxTransferable(LinkedHashMap<String, Object> parameters) {
        ParameterChecker.checkParameter(parameters, "asset", String.class);
        return asyncRequestHandler.sendSignedRequest(baseUrl, MAX_TRANSFERABLE, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> isolatedTransfer(LinkedHashMap<String, Object> parameters) {
        ParameterChecker.checkParameter(parameters, "asset", String.class);
        ParameterChecker.checkParameter(parameters, "symbol", String.class);
        ...
        ParameterChecker.checkRequiredParameter(parameters, "amount");
        return asyncRequestHandler.sendSignedRequest(baseUrl, ISOLATED_TRANSFER, parameters, HttpMethod.POST, showLimitUsage);
    }
     ...
     */
    public Mono<String> getIsolatedTransfer(LinkedHashMap<String, Object> parameters) {
        ParameterChecker.checkParameter(parameters, "symbol", String.class);
        return asyncRequestHandler.sendSignedRequest(baseUrl, ISOLATED_TRANSFER, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> isolatedAccount(LinkedHashMap<String, Object> parameters) {
        return asyncRequestHandler.sendSignedRequest(baseUrl, ISOLATED_ACCOUNT, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> disableIsolatedAccount(LinkedHashMap<String, Object> parameters) {
        ParameterChecker.checkParameter(parameters, "symbol", String.class);
        return asyncRequestHandler.sendSignedRequest(baseUrl, ISOLATED_ACCOUNT, parameters, HttpMethod.DELETE, showLimitUsage);
    }
     ...
     */
    public Mono<String> enableIsolatedAccount(LinkedHashMap<String, Object> parameters) {
        ParameterChecker.checkParameter(parameters, "symbol", String.class);
        return asyncRequestHandler.sendSignedRequest(baseUrl, ISOLATED_ACCOUNT, parameters, HttpMethod.POST, showLimitUsage);
    }
     ...
     */
    public Mono<String> getIsolatedAccountLimit(LinkedHashMap<String, Object> parameters) {
        return asyncRequestHandler.sendSignedRequest(baseUrl, ISOLATED_ACCOUNT_LIMIT, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> getIsolatedSymbol(LinkedHashMap<String, Object> parameters) {
        ParameterChecker.checkParameter(parameters, "symbol", String.class);
        return asyncRequestHandler.sendSignedRequest(baseUrl, ISOLATED_SYMBOL, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> getAllIsolatedSymbols(LinkedHashMap<String, Object> parameters) {
        return asyncRequestHandler.sendSignedRequest(baseUrl, ALL_ISOLATED_SYMBOL, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> bnbBurn(LinkedHashMap<String, Object> parameters) {
        return asyncRequestHandler.sendSignedRequest(baseUrl, BNB_BURN, parameters, HttpMethod.POST, showLimitUsage);
    }
     ...
     */
    public Mono<String> getBnbBurn(LinkedHashMap<String, Object> parameters) {
        return asyncRequestHandler.sendSignedRequest(baseUrl, BNB_BURN, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> interestRateHistory(LinkedHashMap<String, Object> parameters) {
        ParameterChecker.checkParameter(parameters, "asset", String.class);
        return asyncRequestHandler.sendSignedRequest(baseUrl, INTEREST_RATE_HIST, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> crossMarginData(LinkedHashMap<String, Object> parameters) {
        return asyncRequestHandler.sendSignedRequest(baseUrl, CROSS_MARGIN_DATA, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> isolatedMarginData(LinkedHashMap<String, Object> parameters) {
        return asyncRequestHandler.sendSignedRequest(baseUrl, ISOLATED_MARGIN_DATA, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> isolatedMarginTier(LinkedHashMap<String, Object> parameters) {
        ParameterChecker.checkParameter(parameters, "symbol", String.class);
        return asyncRequestHandler.sendSignedRequest(baseUrl, ISOLATED_MARGIN_TIER, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> orderRateLimit(LinkedHashMap<String, Object> parameters) {
        return asyncRequestHandler.sendSignedRequest(baseUrl, ORDER_RATE_LIMIT, parameters, HttpMethod.GET, showLimitUsage);
    }
     ...
     */
    public Mono<String> dribblet(LinkedHashMap<String, Object> parameters) {
        return asyncRequestHandler.sendSignedRequest(baseUrl, DRIBBLET, parameters, HttpMethod.GET, showLimitUsage);
    }
}
