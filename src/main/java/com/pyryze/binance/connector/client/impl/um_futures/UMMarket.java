...
public class UMMarket extends Market {
     ...
     */
    public Mono<String> takerBuySellVol(LinkedHashMap<String, Object> parameters) {
        ParameterChecker.checkParameter(parameters, "symbol", String.class);
        ParameterChecker.checkParameter(parameters, "period", String.class);
        return getAsyncRequestHandler().sendPublicRequest(getBaseUrl(), TAKE_BUY_SELL_VOLUME, parameters, HttpMethod.GET, getShowLimitUsage());
    }
     ...
     */
    public Mono<String> historicalBlvt(LinkedHashMap<String, Object> parameters) {
        ParameterChecker.checkParameter(parameters, "symbol", String.class);
        ParameterChecker.checkParameter(parameters, "interval", String.class);
        return getAsyncRequestHandler().sendPublicRequest(getProductUrl(), HISTORICAL_BLVT, parameters, HttpMethod.GET, getShowLimitUsage());
    }
     ...
     */
    public Mono<String> indexInfo(LinkedHashMap<String, Object> parameters) {
        return getAsyncRequestHandler().sendPublicRequest(getProductUrl(), INDEX_INFO, parameters, HttpMethod.GET, getShowLimitUsage());
    }
     ...
     */
    public Mono<String> assetIndex(LinkedHashMap<String, Object> parameters) {
        return getAsyncRequestHandler().sendPublicRequest(getProductUrl(), ASSET_INDEX, parameters, HttpMethod.GET, getShowLimitUsage());
    }
