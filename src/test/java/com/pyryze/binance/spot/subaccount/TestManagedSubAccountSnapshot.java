...
public class TestManagedSubAccountSnapshot {
    ...
    public void testManagedSubAccountSnapshotWithoutParameters() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createSubAccount().managedSubAccountSnapshot(parameters).block());
    }
    ...
    public void testManagedSubAccountSnapshot() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createSubAccount().managedSubAccountSnapshot(parameters).block();
