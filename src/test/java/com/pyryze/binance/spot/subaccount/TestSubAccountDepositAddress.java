...
public class TestSubAccountDepositAddress {
    ...
    public void testDepositAddWithoutParameters() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createSubAccount().depositAddress(parameters).block());
    }
    ...
    public void testDepositAdd() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createSubAccount().depositAddress(parameters).block();
