...
public class TestEnableLeverageToken {
    ...
    public void testEnableTokenWithoutParameters() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createSubAccount().enableLeverageToken(parameters).block());
    }
    ...
    public void testEnableToken() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createSubAccount().enableLeverageToken(parameters).block();
