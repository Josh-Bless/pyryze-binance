...
public class TestQuerySubAccountFuturesTransfer {
    ...
    public void testFuturesInternalTransferWithoutParameters() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createSubAccount().getFuturesInternalTransfer(parameters).block());
    }
    ...
    public void testFuturesInternalTransfer() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createSubAccount().getFuturesInternalTransfer(parameters).block();
