...
public class TestDeleteIpList {
    ...
    public void testDeleteIpListWithoutParameters() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createSubAccount().deleteIpList(parameters).block());
    }
    ...
    public void  testDeleteIpList() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createSubAccount().deleteIpList(parameters).block();
