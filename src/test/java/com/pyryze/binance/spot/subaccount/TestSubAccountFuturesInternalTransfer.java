...
public class TestSubAccountFuturesInternalTransfer {
    ...
    public void testFuturesInternalTransWithoutParameters() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createSubAccount().futuresInternalTransfer(parameters).block());
    }
    ...
    public void testFuturesInternalTrans() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createSubAccount().futuresInternalTransfer(parameters).block();
