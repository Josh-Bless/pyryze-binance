...
public class TestSubAccountDepositHistory {
    ...
    public void testDepositHistWithoutParameters() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createSubAccount().depositHistory(parameters).block());
    }
    ...
    public void testDepositHist() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createSubAccount().depositHistory(parameters).block();
