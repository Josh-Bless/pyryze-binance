...
public class TestEnableFuturesSubAccount {
    ...
    public void testEnableFuturesWithoutEmail() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createSubAccount().enableFutures(parameters).block());
    }
    ...
    public void testEnableFutures() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createSubAccount().enableFutures(parameters).block();
