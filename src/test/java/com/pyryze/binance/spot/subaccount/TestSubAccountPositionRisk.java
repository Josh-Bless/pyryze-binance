...
public class TestSubAccountPositionRisk {
    ...
    public void testPositionRiskWithoutParameters() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createSubAccount().futuresPositionRisk(parameters).block());
    }
    ...
    public void testPositionRisk() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createSubAccount().futuresPositionRisk(parameters).block();
