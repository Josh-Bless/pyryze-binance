...
public class TestGetIpRestriction {
    ...
    public void testGetIpRestrictionWithoutParameters() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createSubAccount().getIpRestriction(parameters).block());
    }
    ...
    public void testGetIpRestriction() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createSubAccount().getIpRestriction(parameters).block();
