...
public class TestAddIpList {
    ...
    public void testAddIpListWithoutParameters() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createSubAccount().addIpList(parameters).block());
    }
    ...
    public void  testAddIpList() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createSubAccount().addIpList(parameters).block();
