...
public class TestQuerySubAccountAssets {
    ...
    public void testAssetsWithoutParameters() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createSubAccount().assets(parameters).block());
    }
    ...
    public void testAssets() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createSubAccount().assets(parameters).block();
