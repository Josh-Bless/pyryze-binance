...
public class TestFuturesAccountSummaryV2 {
    ...
    public void testFuturesSummaryWithoutType() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createSubAccount().futuresAccountSummaryV2(parameters).block());
    }
    ...
    public void testFuturesSummary() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createSubAccount().futuresAccountSummaryV2(parameters).block();
