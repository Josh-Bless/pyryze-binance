...
public class TestEnableMarginSubAccount {
    ...
    public void testEnableMarginWithoutEmail() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createSubAccount().enableMargin(parameters).block());
    }
    ...
    public void testEnableMargin() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createSubAccount().enableMargin(parameters).block();
