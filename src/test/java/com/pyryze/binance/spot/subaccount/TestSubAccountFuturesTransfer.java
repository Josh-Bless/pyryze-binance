...
public class TestSubAccountFuturesTransfer {
    ...
    public void testFuturesTransWithoutParameters() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createSubAccount().futuresTransfer(parameters).block());
    }
    ...
    public void testFuturesTrans() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createSubAccount().futuresTransfer(parameters).block();
