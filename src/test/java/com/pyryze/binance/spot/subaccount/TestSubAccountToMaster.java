...
public class TestSubAccountToMaster {
    ...
    public void testSubToMasterWithoutParameters() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createSubAccount().subAccountToMaster(parameters).block());
    }
    ...
    public void testSubToMaster() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createSubAccount().subAccountToMaster(parameters).block();
