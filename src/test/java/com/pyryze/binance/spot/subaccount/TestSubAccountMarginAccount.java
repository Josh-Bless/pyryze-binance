...
public class TestSubAccountMarginAccount {
    ...
    public void testMarginWithoutParameters() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createSubAccount().marginAccount(parameters).block());
    }
    ...
    public void testMargin() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createSubAccount().marginAccount(parameters).block();
