...
public class TestCreateVirtualSubAccount {
    ...
    public void testCreateSubAccountWithoutString() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createSubAccount().createVirtualSubAccount(parameters).block());
    }
    ...
    public void testCreateSubAccount() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createSubAccount().createVirtualSubAccount(parameters).block();
