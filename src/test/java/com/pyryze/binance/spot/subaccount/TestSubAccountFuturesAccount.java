...
public class TestSubAccountFuturesAccount {
    ...
    public void testFuturesAccountWithoutParameters() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createSubAccount().futuresAccount(parameters).block());
    }
    ...
    public void testFuturesAccount() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createSubAccount().futuresAccount(parameters).block();
