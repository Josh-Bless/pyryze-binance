...
public class TestFuturesPositionRiskV2 {
    ...
    public void testFuturesPositionRiskWithoutParameters() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createSubAccount().futuresPositionRiskV2(parameters).block());
    }
    ...
    public void testFuturesPositionRisk() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createSubAccount().futuresPositionRiskV2(parameters).block();
