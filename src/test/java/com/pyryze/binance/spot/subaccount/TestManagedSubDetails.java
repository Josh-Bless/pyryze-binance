...
public class TestManagedSubDetails {
    ...
    public void testManagedSubDetailsWithoutParameters() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createSubAccount().managedSubDetails(parameters).block());
    }
    ...
    public void testManagedSubDetails() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createSubAccount().managedSubDetails(parameters).block();
