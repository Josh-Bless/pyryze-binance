...
public class TestCancelOpenOrders {
    ...
    public void testCancelOpenOrdersWithoutSymbol() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createTrade().cancelOpenOrders(parameters).block());
    }
    ...
    public void testCancelOpenOrdersWhenNoOpenOrders() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        assertThrows(BinanceClientException.class, () -> client.createTrade().cancelOpenOrders(parameters).block());
    }
    ...
    public void testCancelOpenOrders() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createTrade().cancelOpenOrders(parameters).block();
