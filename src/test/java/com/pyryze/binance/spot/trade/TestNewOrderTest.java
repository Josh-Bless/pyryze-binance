...
public class TestNewOrderTest {
    ...
    public void testNewOrderWithoutParameters() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createTrade().testNewOrder(parameters).block());
    }
    ...
    public void testNewOrderTest() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createTrade().testNewOrder(parameters).block();
