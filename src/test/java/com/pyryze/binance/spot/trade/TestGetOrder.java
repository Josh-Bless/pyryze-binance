...
public class TestGetOrder {
    ...
    public void testGetOrderWithoutSymbol() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createTrade().getOrder(parameters).block());
    }
    ...
    public void testGetOrderWithoutOrderId() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        assertThrows(BinanceClientException.class, () -> client.createTrade().getOrder(parameters).block());
    }
    ...
    public void testGetOrder() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createTrade().getOrder(parameters).block();
