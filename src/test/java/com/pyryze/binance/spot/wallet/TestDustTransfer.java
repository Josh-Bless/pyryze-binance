...
public class TestDustTransfer {
    ...
    public void testDustTransferWithoutCoin() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createWallet().dustTransfer(parameters).block());
    }
    ...
    public void testDustTransfer() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createWallet().dustTransfer(parameters).block();
