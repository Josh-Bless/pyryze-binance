...
public class TestDepositAddress {
    ...
    public void testDepositAddressWithoutCoin() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createWallet().depositAddress(parameters).block());
    }
    ...
    public void testDepositAddress() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createWallet().depositAddress(parameters).block();
