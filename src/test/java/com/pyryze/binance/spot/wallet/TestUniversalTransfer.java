...
public class TestUniversalTransfer {
    ...
    public void testUniversalTransferWithoutParameters() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createWallet().universalTransfer(parameters).block());
    }
    ...
    public void testUniversalTransfer() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createWallet().universalTransfer(parameters).block();
