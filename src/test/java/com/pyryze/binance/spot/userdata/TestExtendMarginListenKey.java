...
public class TestExtendMarginListenKey {
    ...
    public void testExtendMarginListenKeyWithoutParameters() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createUserData().extendMarginListenKey(parameters).block());
    }
    ...
    public void testExtendMarginListenKey() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createUserData().extendMarginListenKey(parameters).block();
