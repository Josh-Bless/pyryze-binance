...
public class TestExtendListenKey {
    ...
    public void testExtendListenKeyWithoutParameters() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createUserData().extendListenKey(parameters).block());
    }
    ...
    public void testExtendListenKey() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createUserData().extendListenKey(parameters).block();
