...
public class TestExtendIsolatedMarginListenKey {
    ...
    public void testExtendIsolatedListenKeyWithoutParameters() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createUserData().extendIsolatedMarginListenKey(parameters).block());
    }
    ...
    public void testExtendIsolatedListenKey() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createUserData().extendIsolatedMarginListenKey(parameters).block();
