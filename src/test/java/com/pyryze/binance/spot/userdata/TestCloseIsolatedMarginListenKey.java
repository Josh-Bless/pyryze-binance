...
public class TestCloseIsolatedMarginListenKey {
    ...
    public void testCloseIsolatedListenKeyWithoutParameters() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createUserData().closeIsolatedMarginListenKey(parameters).block());
    }
    ...
    public void testCloseIsolatedListenKey() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createUserData().closeIsolatedMarginListenKey(parameters).block();
