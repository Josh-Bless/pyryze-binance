package com.pyryze.binance.spot.futures;
...
public class TestFuturesTransferHistory {
    ...
    public void testFuturesTransferHistoryWithoutParameters() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createFutures().futuresTransferHistory(parameters).block());
    }
    ...
    public void testFuturesTransferHistory() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createFutures().futuresTransferHistory(parameters).block();
