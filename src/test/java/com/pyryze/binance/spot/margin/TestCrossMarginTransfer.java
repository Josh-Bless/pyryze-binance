...
public class TestCrossMarginTransfer {
    ...
    public void testCrossMarginTransferWithoutParameters() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createMargin().crossMarginTransfer(parameters).block());
    }
    ...
    public void testCrossMarginTransfer() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createMargin().crossMarginTransfer(parameters).block();
