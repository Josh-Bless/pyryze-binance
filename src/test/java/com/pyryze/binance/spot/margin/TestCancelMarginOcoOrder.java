...
public class TestCancelMarginOcoOrder {
    ...
    public void testCancelAllMarginOcoOrderWithoutParameters() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createMargin().cancelOcoOrder(parameters).block());
    }
    ...
    public void testCancelAllMarginOcoOrder() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createMargin().cancelOcoOrder(parameters).block();
