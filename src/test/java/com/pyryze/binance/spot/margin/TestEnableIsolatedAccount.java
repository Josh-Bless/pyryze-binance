...
public class TestEnableIsolatedAccount {
    ...
    public void testEnableIsolatedAccountWithoutParameters() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createMargin().enableIsolatedAccount(parameters).block());
    }
    ...
    public void testEnableIsolatedAccount() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createMargin().enableIsolatedAccount(parameters).block();
