...
public class TestMaxTransferable {
    ...
    public void testMaxTransferableWithoutParameters() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createMargin().maxTransferable(parameters).block());
    }
    ...
    public void testMaxTransferable() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createMargin().maxTransferable(parameters).block();
