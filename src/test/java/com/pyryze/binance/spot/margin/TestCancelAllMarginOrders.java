...
public class TestCancelAllMarginOrders {
    ...
    public void testCancelAllMarginOrdersWithoutParameters() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createMargin().cancelOpenOrders(parameters).block());
    }
    ...
    public void testCancelAllMarginOrders() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createMargin().cancelOpenOrders(parameters).block();
