...
public class TestMaxBorrow {
    ...
    public void testMaxBorrowWithoutParameters() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createMargin().maxBorrow(parameters).block());
    }
    ...
    public void testMaxBorrow() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createMargin().maxBorrow(parameters).block();
