...
public class TestLoanRecord {
    ...
    public void testLoanRecordWithoutParameters() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createMargin().loanRecord(parameters).block());
    }
    ...
    public void testLoanRecord() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createMargin().loanRecord(parameters).block();
