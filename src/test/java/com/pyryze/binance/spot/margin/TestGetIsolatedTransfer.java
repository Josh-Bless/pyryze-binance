...
public class TestGetIsolatedTransfer {
    ...
    public void testGetIsolatedTransferWithoutParameters() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createMargin().getIsolatedTransfer(parameters).block());
    }
    ...
    public void testGetIsolatedTransfer() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createMargin().getIsolatedTransfer(parameters).block();
