...
public class TestRepayRecord {
    ...
    public void testRepayRecordWithoutParameters() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createMargin().repayRecord(parameters).block());
    }
    ...
    public void testRepayRecord() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createMargin().repayRecord(parameters).block();
