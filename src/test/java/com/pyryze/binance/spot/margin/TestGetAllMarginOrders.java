...
public class TestGetAllMarginOrders {
    ...
    public void testGetAllMarginOrdersWithoutParameters() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createMargin().getAllOrders(parameters).block());
    }
    ...
    public void testGetAllMarginOrders() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createMargin().getAllOrders(parameters).block();
