...
public class TestInterestRateHistory {
    ...
    public void testInterestRateHistoryWithoutParameters() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createMargin().interestRateHistory(parameters).block());
    }
    ...
    public void testInterestRateHistory() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createMargin().interestRateHistory(parameters).block();
