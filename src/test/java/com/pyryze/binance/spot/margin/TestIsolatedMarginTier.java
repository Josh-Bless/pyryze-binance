...
public class TestIsolatedMarginTier {
    ...
    public void testIsolatedMarginTierWithoutParameters() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createMargin().isolatedMarginTier(parameters).block());
    }
    ...
    public void testIsolatedMarginTier() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createMargin().isolatedMarginTier(parameters).block();
