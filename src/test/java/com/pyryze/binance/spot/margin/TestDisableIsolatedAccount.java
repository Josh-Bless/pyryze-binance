...
public class TestDisableIsolatedAccount {
    ...
    public void testDisableIsolatedAccountWithoutParameters() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createMargin().disableIsolatedAccount(parameters).block());
    }
    ...
    public void testDisableIsolatedAccount() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createMargin().disableIsolatedAccount(parameters).block();
