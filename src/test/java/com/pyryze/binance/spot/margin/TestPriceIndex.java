...
public class TestPriceIndex {
    ...
    public void testPriceIndexWithoutParameters() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createMargin().priceIndex(parameters).block());
    }
    ...
    public void testPriceIndex() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createMargin().priceIndex(parameters).block();
