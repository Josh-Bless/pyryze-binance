...
public class TestCancelMarginOrder {
    ...
    public void testCancelMarginOrderWithoutParameters() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.createMargin().cancelOrder(parameters).block());
    }
    ...
    public void testCancelMarginOcoOrder() {
        ...
        SpotClientImpl client = new SpotClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.createMargin().cancelOrder(parameters).block();
