package com.pyryze.binance.um_futures.portfoliomargin;
...
public class TestUMPortfolioMarginAccountInfo {
    ...
    public void testPortfolioMarginAccountInfoWithoutAsset() {
        ...
        assertThrows(BinanceConnectorException.class, () -> client.portfolioMargin().portfolioMarginAccountInfo(parameters).block());
    }
    ...
    public void testPortfolioMarginAccountInfo() {
        ...
        UMFuturesClientImpl client = new UMFuturesClientImpl(MockData.API_KEY, MockData.SECRET_KEY, baseUrl);
        String result = client.portfolioMargin().portfolioMarginAccountInfo(parameters).block();
